...
local mappings = {
	...
	--  "Buffers",
	--},
	-- ["e"] = { "<Plug>VimwikiUISelect", "Vimwiki" },
	--["w"] = { "<cmd>w!<CR>", "Save" },
	--["q"] = { "<cmd>q!<CR>", "Quit" },
	...
	["u"] = {
		"<cmd>lua require 'gitsigns'.undo_stage_hunk()<CR> :sleep 1<CR> :NvimTreeRefresh<CR>",
		"Undo Stage Hunk",
	},
	...
	g = {
		...
		R = { "<cmd>lua require 'gitsigns'.reset_buffer()<CR> :sleep 1<CR> :NvimTreeRefresh<CR>", "Reset Buffer" },
	...
	l = {
		...
		f = { "<cmd>lua vim.lsp.buf.formatting()<cr> :%s/\r//g<CR> ", "Format" },
		...
		-- h = { "<cmd>lua vim.diagnostic.setloclist()<CR>", "View Diagnostics List" },
		-- h = { "<cmd>Telescope lsp_document_diagnostics<CR>", "View Diagnostics List" },
